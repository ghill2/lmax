...
namespace Com.Lmax.Api
{
    ...
    public class LoginRequest : IRequest
    {
        ...
        /// </param>
        [Obsolete("ProductType is ignored by the server.  Use the appropriate URI for live or demo.")]
        ...
        /// Setting this to <para><b>false</b></para> may cause errors or incorrect behaviour due to protocol changes.
        /// </param>
        public LoginRequest(string username, string password, bool checkProtocolVersion)
            : this(username, password, ProductType.CFD_LIVE, checkProtocolVersion)
        {
        }
