...
namespace Com.Lmax.Api.Order
{
    ...
    public class Order : IEquatable<Order>
    {
        ...
        private readonly string _openingOrderId;
        ...
        /// <summary>
        /// For stop loss and take profit orders this is the ID of the opening order.
        /// <summary>
        public string OpeningOrderId
        {
            get { return _openingOrderId; }
        }
        ...
        public override string ToString()
        {
            return string.Format("Order{{InstructionId: {0}, OriginalInstructionId: {13}, OrderId: {1}, InstrumentId: {2}, AccountId: {3}, Price: {4}, StopLossOffset: {5}, StopProfitOffset: {6}, " +
                                 "StopReferencePrice: {7}, Quantity: {8}, FilledQuantity: {9}, CancelledQuantity: {10}, OrderType: {11}, Commission: {12}, OpeningOrderId: {13}}}", 
                                 _instructionId, _orderId, _instrumentId, _accountId, _price, _stopLossOffset, _stopProfitOffset, _stopReferencePrice, _quantity, 
                                 _filledQuantity, _cancelledQuantity, _orderType, _commission, _originalInstructionId, _openingOrderId);
        }
    }
